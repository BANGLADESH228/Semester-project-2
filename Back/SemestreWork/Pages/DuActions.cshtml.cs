...
namespace SemestreWork.Pages
{
    ...
    {
        IDuActionsRepository _Repository;
        ICommentsRepository _commentsRepository;
        public IRegisterRepository _registerRepository;
        public DuActionsModel(IDuActionsRepository Repository, ICommentsRepository commentsRepository, IRegisterRepository registerRepository)
        {
